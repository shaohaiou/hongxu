        ...
        protected void btnSHzdcpstl_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.TryParse(txtDate.Text, out day1) && DateTime.TryParse(txtDate2.Text, out day2))
            {
                ...
                for (int i = 0; i < corplist.Count; i++)
                {
                    ...
                    decimal sjstljylqq = 100;
                    decimal mbstljylqq = 100;
                    decimal wcljylqq = 100;
                    row["机油滤清器目标"] = mbstljylqq;
                    row["机油滤清器实际"] = sjstljylqq;
                    row["机油滤清器完成率"] = wcljylqq;
                    ...
                    decimal sjstlfdjxhb = hjjylqq == 0 ? 0 : (hjfdjxhb * 100 / hjjylqq);
                    decimal mbstlfdjxhb = mbjylqq == 0 ? 0 : (mbfdjxhb * 100 / mbjylqq);
                    decimal wclfdjxhb = mbstlfdjxhb == 0 ? 0 : (sjstlfdjxhb * 100 / mbstlfdjxhb);
                    row["发动机下护板目标"] = mbstlfdjxhb;
                    row["发动机下护板实际"] = sjstlfdjxhb;
                    row["发动机下护板完成率"] = wclfdjxhb;
                    ...
                    decimal sjstldps = hjjylqq == 0 ? 0 : (hjdps * 100 / hjjylqq);
                    decimal mbstldps = mbjylqq == 0 ? 0 : (mbdps * 100 / mbjylqq);
                    decimal wcldps = mbstldps == 0 ? 0 : (sjstldps * 100 / mbstldps);
                    row["电瓶数目标"] = mbstldps;
                    row["电瓶数实际"] = sjstldps;
                    row["电瓶数完成率"] = wcldps;
                    ...
                    decimal sjstldhsjkhs = hjjylqq == 0 ? 0 : (hjdhsjkhs * 100 / hjjylqq);
                    decimal mbstldhsjkhs = mbjylqq == 0 ? 0 : (mbdhsjkhs * 100 / mbjylqq);
                    decimal wcldhsjkhs = mbstldhsjkhs == 0 ? 0 : (sjstldhsjkhs * 100 / mbstldhsjkhs);
                    row["导航升级客户数目标"] = mbstldhsjkhs;
                    row["导航升级客户数实际"] = sjstldhsjkhs;
                    row["导航升级客户数完成率"] = wcldhsjkhs;
                    ...
                    decimal sjstlktlqq = hjjylqq == 0 ? 0 : (hjktlqq * 100 / hjjylqq);
                    decimal mbstlktlqq = mbjylqq == 0 ? 0 : (mbktlqq * 100 / mbjylqq);
                    decimal wclktlqq = mbstlktlqq == 0 ? 0 : (sjstlktlqq * 100 / mbstlktlqq);
                    row["空调滤清器目标"] = mbstlktlqq;
                    row["空调滤清器实际"] = sjstlktlqq;
                    row["空调滤清器完成率"] = wclktlqq;
                    ...
                    decimal sjstlmfby = hjjylqq == 0 ? 0 : (hjmfby * 100 / hjjylqq);
                    decimal mbstlmfby = mbjylqq == 0 ? 0 : (mbmfby * 100 / mbjylqq);
                    decimal wclmfby = mbstlmfby == 0 ? 0 : (sjstlmfby * 100 / mbstlmfby);
                    row["免费保养目标"] = mbstlmfby;
                    row["免费保养实际"] = sjstlmfby;
                    row["免费保养完成率"] = wclmfby;
                    ...
                    decimal sjstlgdjy = hjjylqq == 0 ? 0 : (hjgdjy * 100 / hjjylqq);
                    decimal mbstlgdjy = mbjylqq == 0 ? 0 : (mbgdjy * 100 / mbjylqq);
                    decimal wclgdjy = mbstlgdjy == 0 ? 0 : (sjstlgdjy * 100 / mbstlgdjy);
                    row["高端机油目标"] = mbstlgdjy;
                    row["高端机油实际"] = sjstlgdjy;
                    row["高端机油完成率"] = wclgdjy;
                    ...
                    decimal sjstlfdjpd = hjjylqq == 0 ? 0 : (hjfdjpd * 100 / hjjylqq);
                    decimal mbstlfdjpd = mbjylqq == 0 ? 0 : (mbfdjpd * 100 / mbjylqq);
                    decimal wclfdjpd = mbstlfdjpd == 0 ? 0 : (sjstlfdjpd * 100 / mbstlfdjpd);
                    row["发动机皮带目标"] = mbstlfdjpd;
                    row["发动机皮带实际"] = sjstlfdjpd;
                    row["发动机皮带完成率"] = wclfdjpd;
                    ...
                    decimal sjstlhhs = hjjylqq == 0 ? 0 : (hjhhs * 100 / hjjylqq);
                    decimal mbstlhhs = mbjylqq == 0 ? 0 : (mbhhs * 100 / mbjylqq);
                    decimal wclhhs = mbstlhhs == 0 ? 0 : (sjstlhhs * 100 / mbstlhhs);
                    row["火花塞目标"] = mbstlhhs;
                    row["火花塞实际"] = sjstlhhs;
                    row["火花塞完成率"] = wclhhs;
                    ...
                    decimal sjstllt = hjjylqq == 0 ? 0 : (hjlt * 100 / hjjylqq);
                    decimal mbstllt = mbjylqq == 0 ? 0 : (mblt * 100 / mbjylqq);
                    decimal wcllt = mbstllt == 0 ? 0 : (sjstllt * 100 / mbstllt);
                    row["轮胎目标"] = mbstllt;
                    row["轮胎实际"] = sjstllt;
                    row["轮胎完成率"] = wcllt;
                    ...
                    decimal sjstlrytjj = hjjylqq == 0 ? 0 : (hjrytjj * 100 / hjjylqq);
                    decimal mbstlrytjj = mbjylqq == 0 ? 0 : (mbrytjj * 100 / mbjylqq);
                    decimal wclrytjj = mbstlrytjj == 0 ? 0 : (sjstlrytjj * 100 / mbstlrytjj);
                    row["燃油添加剂目标"] = mbstlrytjj;
                    row["燃油添加剂实际"] = sjstlrytjj;
                    row["燃油添加剂完成率"] = wclrytjj;
                    ...
                    decimal sjstlfdjkmj = hjjylqq == 0 ? 0 : (hjfdjkmj * 100 / hjjylqq);
                    decimal mbstlfdjkmj = mbjylqq == 0 ? 0 : (mbfdjkmj * 100 / mbjylqq);
                    decimal wclfdjkmj = mbstlfdjkmj == 0 ? 0 : (sjstlfdjkmj * 100 / mbstlfdjkmj);
                    row["发动机抗磨剂目标"] = mbstlfdjkmj;
                    row["发动机抗磨剂实际"] = sjstlfdjkmj;
                    row["发动机抗磨剂完成率"] = wclfdjkmj;
                    ...
                    decimal sjstlbls = hjjylqq == 0 ? 0 : (hjbls * 100 / hjjylqq);
                    decimal mbstlbls = mbjylqq == 0 ? 0 : (mbbls * 100 / mbjylqq);
                    decimal wclbls = mbstlbls == 0 ? 0 : (sjstlbls * 100 / mbstlbls);
                    row["玻璃水目标"] = mbstlbls;
                    row["玻璃水实际"] = sjstlbls;
                    row["玻璃水完成率"] = wclbls;
                    ...
                    decimal sjstlygp = hjjylqq == 0 ? 0 : (hjygp * 100 / hjjylqq);
                    decimal mbstlygp = mbjylqq == 0 ? 0 : (mbygp * 100 / mbjylqq);
                    decimal wclygp = mbstlygp == 0 ? 0 : (sjstlygp * 100 / mbstlygp);
                    row["雨刮片目标"] = mbstlygp;
                    row["雨刮片实际"] = sjstlygp;
                    row["雨刮片完成率"] = wclygp;
                    ...
                    decimal sjstlzfxqx = hjjylqq == 0 ? 0 : (hjzfxqx * 100 / hjjylqq);
                    decimal mbstlzfxqx = mbjylqq == 0 ? 0 : (mbzfxqx * 100 / mbjylqq);
                    decimal wclzfxqx = mbstlzfxqx == 0 ? 0 : (sjstlzfxqx * 100 / mbstlzfxqx);
                    row["蒸发箱清洗目标"] = mbstlzfxqx;
                    row["蒸发箱清洗实际"] = sjstlzfxqx;
                    row["蒸发箱清洗完成率"] = wclzfxqx;
                    ...
                    decimal sjstlktqxj = hjjylqq == 0 ? 0 : (hjktqxj * 100 / hjjylqq);
                    decimal mbstlktqxj = mbjylqq == 0 ? 0 : (mbktqxj * 100 / mbjylqq);
                    decimal wclktqxj = mbstlktqxj == 0 ? 0 : (sjstlktqxj * 100 / mbstlktqxj);
                    row["空调清洗剂目标"] = mbstlktqxj;
                    row["空调清洗剂实际"] = sjstlktqxj;
                    row["空调清洗剂完成率"] = wclktqxj;
                    ...
                    decimal sjstlzdpan = hjjylqq == 0 ? 0 : (hjzdpan * 100 / hjjylqq);
                    decimal mbstlzdpan = mbjylqq == 0 ? 0 : (mbzdpan * 100 / mbjylqq);
                    decimal wclzdpan = mbstlzdpan == 0 ? 0 : (sjstlzdpan * 100 / mbstlzdpan);
                    row["制动盘目标"] = mbstlzdpan;
                    row["制动盘实际"] = sjstlzdpan;
                    row["制动盘完成率"] = wclzdpan;
                    ...
                    decimal sjstlzdpian = hjjylqq == 0 ? 0 : (hjzdpian * 100 / hjjylqq);
                    decimal mbstlzdpian = mbjylqq == 0 ? 0 : (mbzdpian * 100 / mbjylqq);
                    decimal wclzdpian = mbstlzdpian == 0 ? 0 : (sjstlzdpian * 100 / mbstlzdpian);
                    row["制动片目标"] = mbstlzdpian;
                    row["制动片实际"] = sjstlzdpian;
                    row["制动片完成率"] = wclzdpian;
                    ...
                    decimal sjstlzdy = hjjylqq == 0 ? 0 : (hjzdy * 100 / hjjylqq);
                    decimal mbstlzdy = mbjylqq == 0 ? 0 : (mbzdy * 100 / mbjylqq);
                    decimal wclzdy = mbstlzdy == 0 ? 0 : (sjstlzdy * 100 / mbstlzdy);
                    row["制动液目标"] = mbstlzdy;
                    row["制动液实际"] = sjstlzdy;
                    row["制动液完成率"] = wclzdy;
                ...
                foreach (DataRow drow in tblresult.Rows)
                {
                    ...
                    for (int i = 0; i < 19; i++)
                    {
                        row.CreateCell(1 + (i * 3)).SetCellValue(Math.Round(DataConvert.SafeDouble(drow[1 + (i * 3)]),2) + "%");
                        row.CreateCell(2 + (i * 3)).SetCellValue(Math.Round(DataConvert.SafeDouble(drow[2 + (i * 3)]),2) + "%");
                        row.CreateCell(3 + (i * 3)).SetCellValue(Math.Round(DataConvert.SafeDouble(drow[3 + (i * 3)]), 2) + "%");
                    }
                    ...
                    for (int i = 1; i <= 57; i++)
                    {
                        if (tblresult.Columns[i].ColumnName.IndexOf("完成率") >= 0 && DataConvert.SafeDouble(drow[tblresult.Columns[i].ColumnName]) >= 80)
                            sheet.GetRow(index).Cells[i].CellStyle = cellStyleGreen;
                        else if (tblresult.Columns[i].ColumnName.IndexOf("完成率") >= 0 && DataConvert.SafeDouble(drow[tblresult.Columns[i].ColumnName]) >= 60 && DataConvert.SafeDouble(drow[tblresult.Columns[i].ColumnName]) < 80)
                            sheet.GetRow(index).Cells[i].CellStyle = cellStyleYellow;
                        else if (tblresult.Columns[i].ColumnName.IndexOf("完成率") >= 0 && DataConvert.SafeDouble(drow[tblresult.Columns[i].ColumnName]) > 0 && DataConvert.SafeDouble(drow[tblresult.Columns[i].ColumnName]) < 60)
