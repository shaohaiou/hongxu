<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dayreportcheckhistorymg.aspx.cs" EnableViewState="False"  Inherits="Hx.BackAdmin.dayreport.dayreportcheckhistorymg" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showDetail(obj) {
            ...
            var left = $(obj).offset().left - $("#showdetail").width() - 20;
...
<body>
    <div class="ht_main">
        ...
        <table width="1070" border="0" cellspacing="0" cellpadding="0" class="biaoge4" style="background-color: #f4f8fc;">
            <tr>
            ...
            <tr>
                <td>
                    审核人公司：<asp:DropDownList runat="server" ID="ddlCorporation">
                    </asp:DropDownList>
                    审核人部门：<asp:DropDownList runat="server" ID="ddlDepartment">
                    </asp:DropDownList>
                    审核人：<asp:TextBox runat="server" ID="txtOperator" CssClass="srk6"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table width="1070" border="0" cellspacing="0" cellpadding="0" class="biaoge2">
            <asp:Repeater ID="rpthistory" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%# ((Hx.Components.Entity.DailyReportInfo)Eval("CheckedInfo")).DailyReportCheckStatus.ToString()%>
                        </td>
                        <td>
                            <a href="javascript:void(0);" class="btnDetail pl10" val="<%#Eval("ID") %>">查看</a>
                            <div class="pndetail hide">
                                <%# GetDetail(Eval("ReportCorporationID").ToString(), Eval("ReportDepartment").ToString(), Eval("CheckedInfo"))%></div>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
