<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="monthlytargethistorymg.aspx.cs" Inherits="Hx.BackAdmin.dayreport.monthlytargethistorymg" %>
    ...
    <div class="ht_main">
        ...
        <table width="950" border="0" cellspacing="0" cellpadding="0" class="biaoge4" style="background-color: #f4f8fc;">
            <tr>
                ...
                <td>
                    月份：<asp:TextBox runat="server" ID="txtDate" CssClass="srk6 mr10"></asp:TextBox>
                    部门：<asp:DropDownList runat="server" ID="ddlReportDepartment">
                    </asp:DropDownList>
                    公司：<asp:DropDownList runat="server" ID="ddlReportCorporation">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="pndetail hide">
                                <%# GetDetail(Container.DataItem)%></div>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
