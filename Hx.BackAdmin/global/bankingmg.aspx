<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bankingmg.aspx.cs" Inherits="Hx.BackAdmin.global.bankingmg" %>
...
<body>
    ...
    <div class="ht_main">
        <ul class="xnav">
            ...
            <li class="current"><a href="bankingmg.aspx">金融方案</a></li>
