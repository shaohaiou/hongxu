...
(function($) {
	...
	$.fn.calculator.init = function(calc){
		calc.expression = calc.settings.defaulttext;
		calc.text = calc.settings.defaulttext;
	...
	$.fn.calculator.buttons = {
		...
		*/
		...
		13:{symbol:'=', keycode: 13, left:'76%', top:'61%', width:'20%', height:'34%', onPress:function(calc){
                ...
                if($.fn.calculator.countover)
                    $.fn.calculator.countover(calc);
			}  
		},
