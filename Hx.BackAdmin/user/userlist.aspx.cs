...
namespace Hx.BackAdmin.user
{
    public partial class userlist : AdminBase
    {
        ...
        protected override void Check()
        {
            ...
            if (!Admin.Administrator && ((int)Admin.UserRole & (int)Components.Enumerations.UserRoleType.销售经理) == 0 && ((int)Admin.UserRole & (int)Components.Enumerations.UserRoleType.总经理) == 0)
            {
                Response.Clear();
