<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="benzvotemg.aspx.cs" Inherits="Hx.BackAdmin.weixin.benzvotemg" %>
...
<body>
    ...
    <div class="ht_main">
        <ul class="xnav">
            <li class="current"><a href="benzvotemg.aspx">选手管理</a></li>
