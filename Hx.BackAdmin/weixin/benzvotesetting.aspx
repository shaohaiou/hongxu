<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="benzvotesetting.aspx.cs"
    Inherits="Hx.BackAdmin.weixin.benzvotesetting" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>奔驰投票活动设置</title>
...
<body>
    ...
    <div class="ht_main">
        <ul class="xnav">
            <li><a href="benzvotemg.aspx">选手管理</a></li>
            <li><a href="benzvotelist.aspx">投票记录</a></li>
            <li class="current"><a href="benzvotesetting.aspx">活动设置</a></li>
        </ul>
