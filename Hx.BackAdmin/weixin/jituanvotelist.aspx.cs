...
{
    public partial class jituanvotelist : AdminBase
    {
        ...
        private void LoadData()
        {
            ...
            List<JituanvoteInfo> list = WeixinActs.Instance.GetJituanvoteList(pageindex, search_fy.PageSize, query, ref total);
