<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scenecodesettinglist.aspx.cs" Inherits="Hx.BackAdmin.weixin.scenecodesettinglist" %>
...
<body>
    ...
    <div class="ht_main">
        <ul class="xnav">
            <li class="current"><a href="scenecodesettinglist.aspx">场景二维码管理</a></li>
            ...
            <asp:Repeater ID="rpcg" runat="server">
                <ItemTemplate>
                    <li><a href="scenecodemg.aspx?sid=<%#Eval("ID")%>">
                    ...
                    <tr>
                        ...
                        <td class="lan5x">
                            <a href="javascript:void(0);" class="btnDel pl10" val="<%#Eval("ID") %>">删除</a><a
                                class="btnDel pl10" href="scenecodemg.aspx?sid=<%#Eval("ID") %>&from=<%=CurrentUrl %>">管理</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
