<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="votepothunterlist.aspx.cs" Inherits="Hx.BackAdmin.weixin.votepothunterlist" %>
...
<body>
    ...
    <div class="ht_main">
            ...
            <asp:Repeater ID="rptdata" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="votepothunteredit.aspx?sid=<%=GetString("sid") %>&id=<%#Eval("ID") %>&from=<%= CurrentUrl%>" class="pl10">编辑</a>
                            <a href="?action=del&id=<%#Eval("ID") %>&from=<%= CurrentUrl%>" class="btnDel pl10">删除</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        ...
        <div class="lan5x" style="padding-top: 10px;">
            <a href="votepothunteredit.aspx?sid=<%=GetString("sid") %>&from=<%=CurrentUrl %>" class="an4">新 增</a>
        </div>
    </div>
    </form>
</body>
