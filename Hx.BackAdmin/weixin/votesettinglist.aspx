<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="votesettinglist.aspx.cs" Inherits="Hx.BackAdmin.weixin.votesettinglist" %>
...
<body>
    ...
    <div class="ht_main">
        <ul class="xnav">
            <li class="current"><a href="votesettinglist.aspx">投票活动管理</a></li>
            <asp:Repeater ID="rpcg" runat="server">
                <ItemTemplate>
                    <li><a href="votemg.aspx?sid=<%#Eval("ID")%>">
