<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wjdcpt.aspx.cs" Inherits="Hx.BackAdmin.weixin.wjdcpt" %>
...
<head>
    ...
    <title>2015年总经理满意度问卷-普通员工</title>
    <script language="javascript" type="text/javascript">
        var code = "<%= Code%>";
        var openid = "<%= Openid %>";
        var url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=<%=appid%>&redirect_uri=http%3A%2F%2Frb.hongxucar.com%2Fweixin%2Fwjdcpt.aspx%3Fcid=<%=CurrentCompany==null?string.Empty:CurrentCompany.ID.ToString()%>&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
        if (!openInWeixin()) {
            alert("请在微信中进入此页面");
        }
