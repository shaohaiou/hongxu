...
{
    public partial class wjdcpt : WeixinBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(Openid))
                {
                    ...
                    {
                        Session["session-questionnickname"] = (openinfo["nickname"].ToString());
                    }
                }
                LoadData();
            }
        ...
        protected void rptProject_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                listQuestion = listQuestion.FindAll(l => l.QuestionType == QuestionType.普通员工 && l.QuestionItem.ToString() == row["Name"].ToString()).OrderBy(l => l.ID).ToList();
        ...
        protected void btnSubmit_Click()
        {
            ...
            if (!string.IsNullOrEmpty(Openid))
            {
                if (WeixinActs.Instance.CheckQuestionPostUser(Openid))
                {
                    ...
                    record.QuestionType = QuestionType.普通员工;
